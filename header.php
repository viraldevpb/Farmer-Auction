...
$_SESSION["directory"] = "http://localhost/Farmer-auction/";
                ...
                <ul class="list-inline topbar-right pull-right">
                    ...
                    <li>
                        ...
                        if ((isset($_SESSION["isLogedIn"]) && $_SESSION["isLogedIn"] == true)) { ?>
                            <a class="logout" href="<?= $_SESSION["directory"] ?>logout.php" onclick="return confirm_alert(this);">Logout (<?php if (isset($_SESSION["username"])) {
                                                                                                                                                echo ($_SESSION["username"]);
                                                                                                                                            } ?>)</a>
                        <?php    } else { ?>

                            <a class="login" href="<?= $_SESSION["directory"] ?>./login.php">Login</a>
                    </li>
                <?php } ?>
                </ul>
                <!-- end logout function -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            if ((isset($_SESSION["isLogedIn"]) && $_SESSION["isLogedIn"] == true) && (isset($_SESSION["role"]) && $_SESSION["role"] == "1")) { ?>
                                ...
                                <li><a href="<?= $_SESSION["admin"] ?>admin/veggie.php">Vegetable</a></li>
